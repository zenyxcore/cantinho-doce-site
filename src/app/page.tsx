...
import { ShoppingBag, MapPin, Phone, Clock, ChevronRight, Store, PackageOpen } from "lucide-react";
...
export default function Home() {
  ...
  return (
    <main className="min-h-screen font-sans selection:bg-brand-pink selection:text-white bg-stone-50 pb-16 lg:pb-0">
      {/* HEADER */}
          ...
          <div className="flex-1 w-full relative">
            ...
            <div className="grid grid-cols-2 gap-3 sm:gap-4 h-full">
              <div className="flex flex-col gap-3 sm:gap-4 lg:mt-12">
                  <div className="relative aspect-[4/5] rounded-[20px] overflow-hidden shadow-2xl border border-stone-800 group">
                      <Image src="/images/chocolates.jpg" alt="Chocolates" fill className="object-cover group-hover:scale-105 transition-transform duration-500" />
                  </div>
                  <div className="relative aspect-square rounded-[20px] overflow-hidden shadow-2xl border border-stone-800 group">
                      <Image src="/images/lobitos.jpg" alt="Salgadinhos" fill className="object-cover group-hover:scale-105 transition-transform duration-500" />
                  </div>
              </div>
              <div className="flex flex-col gap-3 sm:gap-4 mt-8 lg:-mt-12">
                  <div className="relative aspect-square rounded-[20px] overflow-hidden shadow-2xl border border-stone-800 group">
                      <Image src="/images/doces_pote.jpg" alt="Doces no pote" fill className="object-cover group-hover:scale-105 transition-transform duration-500" />
                  </div>
                  <div className="relative aspect-[4/5] rounded-[20px] overflow-hidden shadow-2xl border border-stone-800 group">
                      <Image src="/images/balas.jpg" alt="Balas" fill className="object-cover group-hover:scale-105 transition-transform duration-500" />
                  </div>
              </div>
            </div>
          </div>
      ...
      <a 
        ...
        target="_blank"
        rel="noreferrer"
        className="fixed bottom-6 right-6 lg:bottom-8 lg:right-8 z-[100] bg-[#25D366] text-white p-4 rounded-full shadow-2xl hover:scale-110 hover:bg-[#20bd5a] transition-all duration-300 flex items-center justify-center group"
        aria-label="Falar no WhatsApp"
      >
        <span className="absolute right-full mr-4 bg-white text-stone-800 text-sm font-bold py-2 px-4 rounded-[12px] shadow-lg opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap pointer-events-none hidden md:block border border-stone-100">
          Como podemos ajudar?
        </span>
